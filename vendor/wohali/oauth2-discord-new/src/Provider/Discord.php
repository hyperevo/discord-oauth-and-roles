...
class Discord extends AbstractProvider
{
    ...
    {
        return $this->apiDomain.$this->resource_url;
        #return $this->apiDomain.'/users/@me';
        #return $this->apiDomain.'/users/@me/guilds';
        #return $this->apiDomain.'/guilds/226193587040157696';
    }
